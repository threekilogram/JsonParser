...
public class JsonParser {
    ...
    private ObjectNodeTree parse(Reader reader, boolean lenient) {
        ...
        ObjectNodeTree parent = null;
        String currentNodeName = null;
        int numberType = mNumberType;
                ...
                switch (peek) {
                    ...
                    case BEGIN_OBJECT:
                        ...
                        if (lastToken == 0) {
                            ...
                            currentNode = new Node(valueContainer, nodeTree);
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            ObjectNodeTree nodeTree = new ObjectNodeTree();
                            currentNode = new Node(valueContainer, parent, currentNodeName, nodeTree);
                            ...
                            currentNode = new Node(valueContainer, array, objectNodeTree);

                        } else if (lastToken == TOKEN_END_OBJECT) {

                            /* 上一步操作是END_OBJECT 说明当前节点是 json array; 并且它的元素都是object类型的 */

                            ArrayNodeTree array = (ArrayNodeTree) currentNode.parent;
                            ObjectNodeTree objectNodeTree = new ObjectNodeTree();
                            currentNode = new Node(valueContainer, array, objectNodeTree);
                        }
                    ...
                    case BEGIN_ARRAY:
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            currentNode = new Node(valueContainer, parent, currentNodeName, arrayNodeTree);
                        }
                    ...
                    case NAME:
                        ...
                        currentNodeName = jsonReader.nextName();
                        ...
                        if (lastToken == TOKEN_BEGIN_OBJECT) {
                            ...
                            parent = currentNode.getObject();

                        } else {

                            /* 只要上一个操作不是 BEGIN_OBJECT ,那么此处就为当前节点添加同级节点 */

                            parent = (ObjectNodeTree) currentNode.parent;
                        }
                    ...
                    case NULL:
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            currentNode = new Node(valueContainer, parent, currentNodeName);
                    ...
                    case STRING:
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            currentNode = new Node(valueContainer, parent, currentNodeName, string);
                    ...
                    case BOOLEAN:
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            currentNode = new Node(valueContainer, parent, currentNodeName, booleanValue);
                    ...
                    case NUMBER:
                        ...
                        if (lastToken == TOKEN_NAME) {
                            ...
                            currentNode = new Node(valueContainer, parent, currentNodeName, numberType,
                                    jsonReader);
                    ...
                    case END_ARRAY:
                        ...
                        if (lastToken == TOKEN_END_OBJECT) {
                            ...
                            currentNode = currentNode.parent.nodeLinkedToTree();
                        }
